...
import dev.kobalt.eqchk.android.main.MainTheme
    ...
    Box(
        ...
        viewState?.event?.let { event ->
            Column(
                ...
                ImageTitleValueLabel(
                    image = painterResource(R.drawable.ic_baseline_south_24),
                    title = "Depth",
                ...
                ImageTitleValueLabel(
                    image = painterResource(R.drawable.ic_baseline_summarize_24),
                    title = "Summary",
                    value = (listOfNotNull(
